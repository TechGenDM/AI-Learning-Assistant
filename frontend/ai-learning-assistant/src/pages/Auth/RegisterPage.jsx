    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white px-4">
      <div className="w-full max-w-md bg-white p-10 rounded-3xl shadow-[0_4px_40px_rgba(0,0,0,0.08)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* Username Field */}
          <div>
            <label className="block text-xs font-semibold text-gray-700 tracking-wider uppercase mb-2">Username</label>
            <div className="relative">
              <div
                className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-200 ${
                  focusedField === "username" ? "text-emerald-500" : "text-gray-300"
                }`}
              >
                <User size={18} />
              </div>
        ...
        <div className="text-center text-sm text-gray-400">
          ...
          <Link to="/login" className="text-emerald-500 font-semibold hover:text-emerald-600 transition-colors">
            Sign in
          </Link>
        </div>
